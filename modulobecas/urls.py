...
urlpatterns = [
    ...
    #path('update_calendar_redirect/', Calendar_show_info.update_calendar_redirect, name='update_calendar_redirect'),
    #path('update_calendar/', Calendar_add.update_calendarX, name='update_calendar'),
